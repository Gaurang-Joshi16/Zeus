...
class ECAPATDNNEngine(ISpeakerVerificationEngine):
...
class ECAPATDNNProvider(IAIProvider):
    def __init__(self, model_manager: ModelManager):
        self._model_manager = model_manager
        self._state = ProviderLifecycleState.UNINITIALIZED
        self._engine = ECAPATDNNEngine()
    ...
    def capabilities(self) -> CapabilityDescriptor:
        return CapabilityDescriptor(
            capability_name="ECAPA-TDNN Speaker Verification",
    ...
    def get_engine(self) -> ISpeakerVerificationEngine:
        return self._engine
