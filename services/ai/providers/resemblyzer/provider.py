...
class ResemblyzerEngine(ISpeakerVerificationEngine):
...
class ResemblyzerProvider(IAIProvider):
    def __init__(self, model_manager: ModelManager):
        self._model_manager = model_manager
        self._state = ProviderLifecycleState.UNINITIALIZED
        self._engine = ResemblyzerEngine()
    ...
    def capabilities(self) -> CapabilityDescriptor:
        return CapabilityDescriptor(
            capability_name="Resemblyzer Speaker Verification",
